...
package test.org.springdoc.api.v30.app76;
...
public class HelloController {
	...
	public Mono<String> parse(
			...
			@Parameter(description = "Resume file to be parsed", content = @Content(mediaType = MediaType.APPLICATION_OCTET_STREAM_VALUE))
			FilePart resumeFile) {
		return null;
	}
}
