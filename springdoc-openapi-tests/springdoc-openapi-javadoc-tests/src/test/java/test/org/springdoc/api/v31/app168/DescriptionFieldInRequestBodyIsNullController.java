...
class DescriptionFieldInRequestBodyIsNullController {
	...
	@PostMapping
	public void person(
			@io.swagger.v3.oas.annotations.parameters.RequestBody(content = @Content(schema = @Schema(implementation = Person.class)))
