...
package test.org.springdoc.api.v31.app9.component.service;
...
public class ComponentsService {
	...
	private static final Map<String, DemoComponent> repo =
			Collections.singletonMap("1", DemoComponent.builder().id("1").payload("Hello World !").build());
