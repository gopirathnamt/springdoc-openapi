 ...
 *
 */
package test.org.springdoc.api.v31.app81;
...
public class SpringDocApp81Test extends AbstractCommonTest {
	...
	public void shouldGenerateOperationIdsDeterministically() throws Exception {
		...
		String expected = getContent("results/3.1.0/app81.json");
	...
	@ComponentScan(basePackages = {"org.springdoc", "test.org.springdoc.api.v31.app81"})
