...
public class SpringDocApp67Test extends AbstractSpringDocTest {
	...
	@Test
	void testApp() {
		webTestClient.get().uri(Constants.DEFAULT_API_DOCS_URL + groupName).exchange().expectStatus().isOk()
		             .expectBody()
	...
	@ComponentScan(basePackages = {"org.springdoc", "test.org.springdoc.api.v31.app67"})
