...
public class MethodAttributesTest {
	...
	void testMergeArrays() throws Exception {
		...
		Method mergeArraysMethod =
				MethodAttributes.class.getDeclaredMethod("mergeArrays", String[].class, String[].class);
	...
	void methodConsumesOverridesClassConsumes() {
		...
		Method method = this.getClass().getDeclaredMethods()[0];
		try (MockedStatic<AnnotatedElementUtils> annotatedElementUtils = Mockito.mockStatic(
